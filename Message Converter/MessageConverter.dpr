...
procedure Convert(Input:String; LineLength:Integer);
var
  OutputFile: TextFile;
...
begin
  ...
  For Counter := 0 to Trunc(length(Input)/LineLength) do
   begin
    Write(OutputFile,'DB ');
    For Counter2 := 0 to LineLength do
    begin
